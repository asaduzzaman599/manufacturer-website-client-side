            ...
            <div className="hero-content flex flex-col gap-10 lg:flex-row md:text-right">
                ...
                <div className='md:pl-16 md:pr-6 w-full'>
                    ...
                    <p className="py-6 md:text-right" data-aos="fade-left" data-aos-delay="75"
                        data-aos-duration="1100" >We are manufacture company work with car part, provide whole sale car parts. So make sure your product lot with qualityful and durable car parts to ensure your customers trust.</p>
