...
const Part = ({ part }) => {
    return (
        <div className="flex flex-col justify-between max-w-lg bg-base-100 shadow-xl hover:shadow-2xl mt-12 border-2" data-aos="fade-up"
            data-aos-duration="3000">
            <div>
                <figure><img src={part?.img} className="w-full p-10 h-60" alt="vehicle part" /></figure>
